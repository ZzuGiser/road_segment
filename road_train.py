...
class RoadDataset(utils.Dataset):
    ...
    def load_road(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            name_dict = {"road": 1}
            # name_dict = {"road": 1, "not_defined":2}
...
############################################################
#  Training
#  python road_train.py train --dataset=D:\360download\code_targetdetection\Mask_RCNN-master\samples\road --weights=coco
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detects road.')
